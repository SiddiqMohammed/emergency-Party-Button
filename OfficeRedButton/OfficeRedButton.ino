...
int trackNumber[] = {1, 2, 3, 4, 5, 6, 7, 8, 9};
int i = 1;
int k = 0;
...
void loop() {
  ...
  if ((millis() - lastDebounceTime1) > debounceDelay)
  {
    if (reading1 != buttonState1)
    {
      ...
      else if (buttonState == 1) // Long Press
      {
        parse_menu(48 + 9);
        // Serial.print("1");
      }
      else if (buttonState == 2 && seekState == 0) // Short Press
      {
        seekState = 1;
      ...
      else if (buttonState == 2 && seekState == 1) // Short Press
      {
        seekState = 0;
        parse_menu(115);
      }
      ...
      //      if (buttonState1 == HIGH && seekState == 0)
      //      {
      //        seekState = 1;
      //
      //        parse_menu(48 + i);
      ...
      //        }
      //
      //      } else if (buttonState1 == HIGH && seekState == 1)
      //      {
      //        seekState = 0;
      //        parse_menu(115);
      //      }
